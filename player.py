...
class Player(Entity):
    ...
    def __init__(
        ...
        player_image_path = os.path.join(os.path.dirname(__file__), 'graphics', 'sprites', 'player.png')
        ...
        sound_path = os.path.join(base_path, "audio", "sword.wav")
        self.weapon_attack_sound = pygame.mixer.Sound(sound_path)
